...
class FoormDetail extends Foorm
{
    ...
    {
        $fields = parent::fillFormMetadataFields($fields); // TODO: Change the autogenerated stub

        $fields = $this->manageMetadataFieldsReferredData($fields);

        return $fields;
    }

    protected function manageMetadataFieldsReferredData($fields = [])
    {
